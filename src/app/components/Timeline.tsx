...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full bg-gradient-to-br from-slate-50 to-indigo-50 font-sans md:px-10 relative z-0"
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-5xl md:text-6xl mb-4 font-black">
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-white flex items-center justify-center shadow-lg">
                <div className="h-4 w-4 rounded-full bg-gradient-to-br from-indigo-600 to-purple-600 border-2 border-white p-2" />
              </div>
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-pink-500 via-purple-500 to-indigo-600 from-[0%] via-[50%] rounded-full"
          />
        </div>
      </div>
    </div>
