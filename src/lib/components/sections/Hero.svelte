...
>
	...
	<div class="absolute top-0 bottom-0 left-[80%] w-[1px] bg-[var(--color-text)] opacity-[0.06] pointer-events-none"></div>

	<!-- Main Content -->
	<div class="container relative z-10">
		<div class="max-w-6xl">
			<h1 class="mb-6 md:mb-8">
				{#each headingText as line, lineIndex (line)}
					<div class="overflow-hidden">
						<span class="inline-block font-display font-bold leading-[0.9] tracking-tighter" style="font-size: clamp(3.5rem, 12vw, 10rem);">
							{#each splitChars(line) as char, i (i)}
								<span
